...
//           <div className="flex flex-col items-center lg:items-start">
//             <p className="my-2 max-w-xl py-6">{ABOUT_TEXT}</p>
//             <button className="mt-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 text-white font-semibold transition duration-300 ease-in-out hover:from-pink-500 hover:to-purple-500">
//               Learn More
//             </button>
//           </div>
//         </motion.div>
